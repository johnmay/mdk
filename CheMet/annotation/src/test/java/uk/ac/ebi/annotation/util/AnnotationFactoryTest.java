...
public class AnnotationFactoryTest {
    ...
    public void testOfClass() {
        System.out.println(AnnotationFactory.getInstance().ofClass(Citation.class).getClass());
        System.out.println(AnnotationFactory.getInstance().ofClass(CrossReference.class).getClass());
    }
