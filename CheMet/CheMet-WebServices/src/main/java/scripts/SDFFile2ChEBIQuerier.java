 ...
 * @author pmoreno
 */
public class SDFFile2ChEBIQuerier {
    ...
    public void execute() throws IOException {
        ...
        while (reader.hasNext()) {
            ...
            if (!isGeneric(mol)) {
                HashMap<String, Float> res = cebiwsc.similaritySearch(mol, this.tanimotoCutoff);
                if (res != null) {
    ...
    public static void main(String[] args) throws IOException  {
        ...
        SDFFile2ChEBIQuerier chEBIQuerier = new SDFFile2ChEBIQuerier();
