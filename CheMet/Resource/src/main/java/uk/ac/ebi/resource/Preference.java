...
public enum Preference {
    ...
    /* Resource */
    CHEMICAL_IDENTIFIER_FORMAT(Type.IDENTIFIER, Access.USER, "M/%i"),
    PROTEIN_IDENTIFIER_FORMAT(Type.IDENTIFIER, Access.USER, "P/%i"),
    GENE_IDENTIFIER_FORMAT(Type.IDENTIFIER, Access.USER, "G/%i"),
    REACTION_IDENTIFIER_FORMAT(Type.IDENTIFIER, Access.USER, "R/%i"),
    /* Tool */
