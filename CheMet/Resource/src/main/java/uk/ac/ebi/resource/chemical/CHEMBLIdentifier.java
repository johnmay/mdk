...
public class CHEMBLIdentifier
    ...
    private static final IdentifierMetaInfo DESCRIPTION = IDENTIFIER_LOADER.getMetaInfo(
            CHEMBLIdentifier.class);


    public CHEMBLIdentifier() {
    }


    public CHEMBLIdentifier(String accession) {
        super(accession);
    }
     ...
     */
    @Override
    public CHEMBLIdentifier newInstance() {
        return new CHEMBLIdentifier();
    }
