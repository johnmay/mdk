...
public class Enzyme {
	...
	private List<String> ecNumbers;
        private List<ExpEvidence> knownEvidences;

        private void init() {
            this.names = new ArrayList<String>();
            this.ecNumbers = new ArrayList<String>();
            this.knownEvidences = new ArrayList<ExpEvidence>();
        }
	...
	public void addExpEvidence(ExpEvidence n) {
            this.knownEvidences.add(n);
        }
        public void removeExpEvidence(ExpEvidence r) {
            this.knownEvidences.remove(r);
        }
