...
public abstract class ObjectDescriptor
    ...
    private static final org.apache.log4j.Logger logger = org.apache.log4j.Logger.getLogger( ObjectDescriptor.class );
    ...
    public boolean addAnnotation( AbstractAnnotation annotation ) {
        logger.debug( "Adding annotation: " + annotation.toString() + " to object: " + this.toString() );
    ...
    public boolean removeAnnotation( AbstractAnnotation annotation ) {
        logger.debug( "Removing annotation: " + annotation.toString() + " from object: " + this.toString() );
    ...
    public boolean addObservation( AbstractObservation observation ) {
        logger.debug( "Adding observation: " + observation.toString() + " to object: " + this.toString() );
    ...
    public boolean removeObservation( AbstractObservation observation ) {
        logger.debug( "Removing observation: " + observation.toString() + " from object: " + this.toString() );
