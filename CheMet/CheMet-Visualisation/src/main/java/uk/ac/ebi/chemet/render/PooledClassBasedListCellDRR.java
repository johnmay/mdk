 ...
 */
public class PooledClassBasedListCellDRR
        extends ClassBasedListCellDDR {

    private static final Logger LOGGER = Logger.getLogger(PooledClassBasedListCellDRR.class);
