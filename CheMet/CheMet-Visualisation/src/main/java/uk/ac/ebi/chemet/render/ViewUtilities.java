...
public class ViewUtilities {
    ...
    private static final org.apache.log4j.Logger logger =
                                                 org.apache.log4j.Logger.getLogger(ViewUtilities.class);
    // mono space fonts
    ...
    public static final Font VERDANA_UNDERLINE_BOLD_11 = getUnderlineBoldFont("SansSerif", 11);
    ...
    public static BufferedImage getImage(String path) {
        ...
        try {
            img = ImageIO.read(ViewUtilities.class.getResource(path));
