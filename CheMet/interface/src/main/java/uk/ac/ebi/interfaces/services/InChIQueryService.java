 ...
 */
public interface InChIQueryService {


    public Collection<Identifier> searchWithInChI(Identifier inchi);


    public Collection<Identifier> getInChIs(Identifier identifier);
