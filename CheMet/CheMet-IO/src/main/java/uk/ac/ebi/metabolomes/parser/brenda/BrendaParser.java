...
public class BrendaParser {
    ...
    private BrendaParser(String path, String specie) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        BrendaParser parser = new BrendaParser("/Users/pmoreno/Documents/June2011/brenda_dl_0210.txt", "Homo sapiens");
        ...
        BrendaName2MolContainer bnmc = new BrendaName2MolContainer("/Users/pmoreno/Documents/June2011/brendaParsing/name2BrendaMolID.txt");
        bnmc.load();
        ...
        System.out.println("RE Metabolites:" + metabolitesRE.size());
        System.out.println("RE Metabolites With Struct:" + foundInMolNames);
    ...
    public BrendaEntryEnzyme next() throws IOException {
        ...
        while (line != null) {
            ...
            if (line.startsWith("ID\t")) {
                ...
                this.enzyme.addReaction(reactionParser.getRxn());
                ...
                if (nsplp.getRxn().getMetabolites().size() > 0) {
                    ...
                    for (String dummyProtId : nsplp.getFoundDummyIdentifersOfProteins()) {
                        this.enzyme.addNatSubsProdRxn(nsplp.getRxn(),dummyProtId);
                    }
