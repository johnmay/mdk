 ...
 */
public class KEGGMoleculeConnectivityService
    ...
    private KEGGMoleculeConnectivityService() {
    ...
    public static KEGGMoleculeConnectivityService getInstance() {
        return KEGGMoleculeConnectivityServiceHolder.INSTANCE;
    }

    public Collection<KEGGCompoundIdentifier> getEntriesWithConnectivity(String connectivity) {
    ...
    private Collection<KEGGCompoundIdentifier> reverseSearch(Query query) {
        ...
        try {
            ...
            for (ScoreDoc scoreDoc : hits) {
                KEGGCompoundIdentifier ident = getIdentifier();
