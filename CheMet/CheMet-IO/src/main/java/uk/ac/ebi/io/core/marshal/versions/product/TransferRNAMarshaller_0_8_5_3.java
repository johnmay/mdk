 ...
 *
 */
public class TransferRNAMarshaller_0_8_5_3 extends AbstractAnnotatedEntityMarshaller {

    private static final Logger LOGGER = Logger.getLogger(TransferRNAMarshaller_0_8_5_3.class);


    public TransferRNAMarshaller_0_8_5_3() {
        super(new Version(0, 8, 5, 3));
    }


    public TransferRNA read(ReconstructionInputStream in) throws IOException, ClassNotFoundException {

        TransferRNA rrna = getEntityFactory().newInstance(TransferRNA.class);
