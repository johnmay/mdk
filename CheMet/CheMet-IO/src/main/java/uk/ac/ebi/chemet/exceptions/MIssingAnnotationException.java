/**
 * MissingAnnotationException.java
 *
 * 2011.08.15
 *
...
/**
 * @name    MissingAnnotationException – 2011.08.15
 *          Class description
...
public class MissingAnnotationException extends Exception {
    ...
    private static final Logger LOGGER = Logger.getLogger( MissingAnnotationException.class );
