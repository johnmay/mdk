...
//        for ( OldGeneProduct product : products.getAllProducts() ) {
...
//    }
//
//    public static ECNumber getECCode( OldGeneProduct product ) {
...
//    }
//
//    public static String[] getFirstECNumber( OldGeneProduct product , List<BlastHit> hits ) {
