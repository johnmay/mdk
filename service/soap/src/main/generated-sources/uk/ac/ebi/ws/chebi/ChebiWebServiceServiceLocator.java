...
public class ChebiWebServiceServiceLocator extends org.apache.axis.client.Service implements uk.ac.ebi.ws.chebi.ChebiWebServiceService {
    ...
    public uk.ac.ebi.ws.chebi.ChebiWebServicePortType getChebiWebServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public uk.ac.ebi.ws.chebi.ChebiWebServicePortType getChebiWebServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            uk.ac.ebi.ws.chebi.ChebiWebServiceBindingStub _stub = new uk.ac.ebi.ws.chebi.ChebiWebServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (uk.ac.ebi.ws.chebi.ChebiWebServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                uk.ac.ebi.ws.chebi.ChebiWebServiceBindingStub _stub = new uk.ac.ebi.ws.chebi.ChebiWebServiceBindingStub(new java.net.URL(ChebiWebServicePort_address), this);
                _stub.setPortName(getChebiWebServicePortWSDDServiceName());
                return _stub;
            }
        }
