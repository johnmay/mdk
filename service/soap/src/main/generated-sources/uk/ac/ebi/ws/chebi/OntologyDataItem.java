...
public class OntologyDataItem  implements java.io.Serializable {
    ...
    private uk.ac.ebi.ws.chebi.CommentDataItem[] comments;

    private uk.ac.ebi.ws.chebi.OntologyDataItem[] ontologyElement;
    ...
    public OntologyDataItem(
           ...
           uk.ac.ebi.ws.chebi.CommentDataItem[] comments,
           uk.ac.ebi.ws.chebi.OntologyDataItem[] ontologyElement) {
     ...
     * @return comments
     */
    public uk.ac.ebi.ws.chebi.CommentDataItem[] getComments() {
        return comments;
    }
     ...
     * @param comments
     */
    public void setComments(uk.ac.ebi.ws.chebi.CommentDataItem[] comments) {
        this.comments = comments;
    }

    public uk.ac.ebi.ws.chebi.CommentDataItem getComments(int i) {
        return this.comments[i];
    }

    public void setComments(int i, uk.ac.ebi.ws.chebi.CommentDataItem _value) {
     ...
     */
    public uk.ac.ebi.ws.chebi.OntologyDataItem[] getOntologyElement() {
        return ontologyElement;
    }
     ...
     */
    public void setOntologyElement(uk.ac.ebi.ws.chebi.OntologyDataItem[] ontologyElement) {
        this.ontologyElement = ontologyElement;
    }

    public uk.ac.ebi.ws.chebi.OntologyDataItem getOntologyElement(int i) {
        return this.ontologyElement[i];
    }

    public void setOntologyElement(int i, uk.ac.ebi.ws.chebi.OntologyDataItem _value) {
