...
public class QueryServiceLocator extends org.apache.axis.client.Service implements uk.ac.ebi.ws.ols.QueryService {
    ...
    public uk.ac.ebi.ws.ols.Query getOntologyQuery(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            uk.ac.ebi.ws.ols.OntologyQuerySoapBindingStub _stub = new uk.ac.ebi.ws.ols.OntologyQuerySoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (uk.ac.ebi.ws.ols.Query.class.isAssignableFrom(serviceEndpointInterface)) {
                uk.ac.ebi.ws.ols.OntologyQuerySoapBindingStub _stub = new uk.ac.ebi.ws.ols.OntologyQuerySoapBindingStub(new java.net.URL(OntologyQuery_address), this);
                _stub.setPortName(getOntologyQueryWSDDServiceName());
                return _stub;
            }
        }
