...
public class PUGLocator extends org.apache.axis.client.Service implements gov.nih.nlm.ncbi.pubchem.ws.PUG {
    ...
    public gov.nih.nlm.ncbi.pubchem.ws.PUGSoap getPUGSoap() throws javax.xml.rpc.ServiceException {
    ...
    public gov.nih.nlm.ncbi.pubchem.ws.PUGSoap getPUGSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            gov.nih.nlm.ncbi.pubchem.ws.PUGSoapStub _stub = new gov.nih.nlm.ncbi.pubchem.ws.PUGSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (gov.nih.nlm.ncbi.pubchem.ws.PUGSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                gov.nih.nlm.ncbi.pubchem.ws.PUGSoapStub _stub = new gov.nih.nlm.ncbi.pubchem.ws.PUGSoapStub(new java.net.URL(PUGSoap_address), this);
                _stub.setPortName(getPUGSoapWSDDServiceName());
                return _stub;
            }
        }
