...
public class PCIDType implements java.io.Serializable {
    ...
    public static final java.lang.String _eID_ConformerID = "eID_ConformerID";
    public static final java.lang.String _eID_SourceID = "eID_SourceID";
    public static final java.lang.String _eID_InChI = "eID_InChI";
    public static final java.lang.String _eID_InChIKey = "eID_InChIKey";
    ...
    public static final PCIDType eID_ConformerID = new PCIDType(_eID_ConformerID);
    public static final PCIDType eID_SourceID = new PCIDType(_eID_SourceID);
    public static final PCIDType eID_InChI = new PCIDType(_eID_InChI);
    public static final PCIDType eID_InChIKey = new PCIDType(_eID_InChIKey);
