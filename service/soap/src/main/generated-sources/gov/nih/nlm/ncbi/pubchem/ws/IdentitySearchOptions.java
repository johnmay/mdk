...
public class IdentitySearchOptions  implements java.io.Serializable {
    private gov.nih.nlm.ncbi.pubchem.ws.IdentityType eIdentity;
    ...
    public IdentitySearchOptions(
           gov.nih.nlm.ncbi.pubchem.ws.IdentityType eIdentity,
     ...
     * @return eIdentity
     */
    public gov.nih.nlm.ncbi.pubchem.ws.IdentityType getEIdentity() {
        return eIdentity;
    }
     ...
     * @param eIdentity
     */
    public void setEIdentity(gov.nih.nlm.ncbi.pubchem.ws.IdentityType eIdentity) {
        this.eIdentity = eIdentity;
    }
