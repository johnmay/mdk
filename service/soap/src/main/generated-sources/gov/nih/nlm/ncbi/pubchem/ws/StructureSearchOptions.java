...
public class StructureSearchOptions  implements java.io.Serializable {
    ...
    private gov.nih.nlm.ncbi.pubchem.ws.StereoType eStereo;
    ...
    public StructureSearchOptions(
           ...
           gov.nih.nlm.ncbi.pubchem.ws.StereoType eStereo,
     ...
     * @return eStereo
     */
    public gov.nih.nlm.ncbi.pubchem.ws.StereoType getEStereo() {
        return eStereo;
    }
     ...
     * @param eStereo
     */
    public void setEStereo(gov.nih.nlm.ncbi.pubchem.ws.StereoType eStereo) {
        this.eStereo = eStereo;
    }
