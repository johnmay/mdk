...
public class PubChemCompoundAdapterTest {
    ...
    @Test public void testGetSynonyms() {
        Collection<String> actual = service.getSynonyms(
            new PubChemCompoundIdentifier("12"));
        assertThat(actual, hasItems("benzene-1,2,3,5-tetrol",
                                    "1,2,3,5-tetrahydroxybenzene", "634-94-6",
                                    "C03743", "AC1Q79ZN", "AC1L18A1",
                                    "CHEBI:16746", "1235-TETRAHYDROXYBENZENE",
                                    "KST-1B6889", "AR-1B5201", "ZINC00901826",
                                    "AKOS006312269", "AG-K-73579", "A8823"));
    }

    @Test public void testSearchName() {
        Collection<PubChemCompoundIdentifier> cids = service.searchName(
            "pyruvate", false);
    ...
    @Test public void testGetIUPACName() {
        String actual = service.getIUPACName(new PubChemCompoundIdentifier(
            "12"));
    ...
    @Test public void testGetFormula() {
        String actual = service.getMolecularFormula(
            new PubChemCompoundIdentifier("12"));
    ...
    @Test public void testGetNames() {
        Collection<String> actual = service.getNames(
            new PubChemCompoundIdentifier("12"));
        assertThat(actual, hasItems("1,2,3,5-Benzenetetrol",
    ...
    @Test public void testGetPreferredName() {
        String actual = service.getPreferredName(new PubChemCompoundIdentifier(
            "12"));
    ...
    @Test public void testGetStructure() {
        IAtomContainer molecule = service.getStructure(
            new PubChemCompoundIdentifier("12"));
