...
import uk.ac.ebi.mdk.identifier.IdentifierSet;
import uk.ac.ebi.mdk.identifier.classification.*;
import uk.ac.ebi.mdk.identifier.PubMedIdentifier;
import uk.ac.ebi.mdk.identifier.SwissProtIdentifier;
import uk.ac.ebi.mdk.identifier.TrEMBLIdentifier;
import uk.ac.ebi.mdk.domain.identifier.type.SequenceIdentifier;
import uk.ac.ebi.mdk.identifier.InChI;
import uk.ac.ebi.mdk.identifier.basic.*;
import uk.ac.ebi.mdk.identifier.basic.ChromosomeNumber;
import uk.ac.ebi.mdk.identifier.*;
import uk.ac.ebi.mdk.identifier.Taxonomy;
import uk.ac.ebi.mdk.identifier.HSSPIdentifier;
import uk.ac.ebi.mdk.identifier.PDBIdentifier;
