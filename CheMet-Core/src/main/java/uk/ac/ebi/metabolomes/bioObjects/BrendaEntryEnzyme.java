...
public class BrendaEntryEnzyme {
    ...
    private HashMap<Integer, List<Citation>> nsp2citations; // Holds the index of the naturalSubs and the citation numbers of the citations
    private HashMap<Integer, List<Citation>> tissue2citations;
    private HashMap<Integer, List<Citation>> localization2citations;
