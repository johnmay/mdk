 ...
 */
public class HMDBTissueMarshalTest {
    
    public HMDBTissueMarshalTest() {
    }


    /**
     * Test of marshal method, of class HMDBTissueMarshal.
     */
    @Test
    public void testTissueMarshal() throws Exception {
        ...
        Mockito.when(xmlr.getLocalName()).thenReturn("tissue").thenReturn("tissue_locations");
        Mockito.when(xmlr.getText()).thenReturn("Liver");

        HMDBTissueMarshal tissueMarshal = new HMDBTissueMarshal();
        
        tissueMarshal.marshal(xmlr, metabolite);

        assertTrue(metabolite.getBodyFluids().contains("Liver"));
    }
}
