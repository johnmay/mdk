 ...
 */
public class HMDBMoleculeConnectivityService
    ...
    private HMDBMoleculeConnectivityService() {
    ...
    public static HMDBMoleculeConnectivityService getInstance() {
        return HMDBMoleculeConnectivityServiceHolder.INSTANCE;
    }

    public Collection<HMDBIdentifier> getEntriesWithConnectivity(String connectivity) {
    ...
    private static class HMDBMoleculeConnectivityServiceHolder {
        ...
        private static final HMDBMoleculeConnectivityService INSTANCE = new HMDBMoleculeConnectivityService();
    }

    private Collection<HMDBIdentifier> reverseSearch(Query query) {
        Collection<HMDBIdentifier> ids = new HashSet<HMDBIdentifier>();
        ...
        try {
            ...
            for (ScoreDoc scoreDoc : hits) {
                HMDBIdentifier ident = getIdentifier();
