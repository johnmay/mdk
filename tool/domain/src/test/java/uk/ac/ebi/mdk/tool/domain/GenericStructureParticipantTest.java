 ...
 * @author John May
 */
public class GenericStructureParticipantTest {

    private final Predicate<MetabolicReaction> predicate = new GenericStructureParticipant();
    ...
    public void testApply() throws Exception {
        ...
        when(m1.isGeneric()).thenReturn(false);
        when(m2.isGeneric()).thenReturn(false);
        when(m3.isGeneric()).thenReturn(false);
        when(m4.isGeneric()).thenReturn(false);
    ...
    @Test
    public void testApply_One() throws Exception {
        ...
        when(m2.isGeneric()).thenReturn(false);
        when(m3.isGeneric()).thenReturn(false);
        when(m4.isGeneric()).thenReturn(true);
    ...
    @Test
    public void testApply_All() throws Exception {
        ...
        when(m1.isGeneric()).thenReturn(true);
        when(m2.isGeneric()).thenReturn(true);
        when(m3.isGeneric()).thenReturn(true);
        when(m4.isGeneric()).thenReturn(true);
